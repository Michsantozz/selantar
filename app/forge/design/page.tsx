...
/* ═══════════════════════════════════════════════
   ...
   Modeled after Factory "03 - COMMAND LINE" panel
   ═══════════════════════════════════════════════ */
function ParseCard() {
  return (
    <motion.div
      {...cardReveal(0.15)}
      className="group flex h-full flex-col rounded-xl border border-border bg-card"
    >
      {/* ── Card header ── */}
      ...
      <div className="flex flex-1 flex-col px-7 pt-8 pb-7">
        ...
        {/* Upload zone — generous, centered */}
        <div className="rounded-lg border border-dashed border-border/80 bg-muted/[0.04] px-6 py-10 text-center transition-all duration-500 group-hover:border-primary/20 group-hover:bg-primary/[0.015]">
          <div className="mx-auto mb-4 flex size-11 items-center justify-center rounded-lg bg-muted/30">
...
/* ═══════════════════════════════════════════════
   CARD 2 — Go to War
   Scenario cards with images, VS blocks, metadata
   ═══════════════════════════════════════════════ */
function WarCard() {
  return (
    <motion.div
        ...
        {scenarios.map((scenario, i) => {
          ...
          return (
            <Link
              ...
              className="group/sc flex flex-col overflow-hidden rounded-lg border border-border bg-background transition-colors duration-500 hover:border-primary/25"
            >
              {/* Image strip */}
              ...
              <div className="flex flex-col gap-2 px-4 pb-4 pt-2">
                ...
                <div className="flex items-baseline justify-between gap-2">
                  <h4 className="flex items-center gap-2 text-[14px] font-medium tracking-tight text-foreground">
...
/* ═══════════════════════════════════════════════
   PAGE — Title LEFT (narrow), Cards RIGHT (side by side)
   Locked to viewport on FHD
   ═══════════════════════════════════════════════ */
export default function ForgeDesignPage() {
  return (
    <div className="relative h-[calc(100dvh-65px)] overflow-hidden">
      ...
      <div className="relative mx-auto flex h-full max-w-[1600px] gap-12 px-8 py-8 lg:px-12">
        ...
        {/* ─── LEFT: Title panel (narrow, vertically centered) ─── */}
        <motion.aside
